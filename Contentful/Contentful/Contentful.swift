...
private struct Unboxable<T>: Decodable {
    ...
    init(from decoder: Decoder) throws {
        let unboxing = decoder.userInfo[CodingUserInfoKey(rawValue: "fieldUnboxer")!] as! ((String) -> UnboxedType?)
    ...
    static func unboxableFields(fromDecoder decoder: Decoder, withUnboxing unboxing: ((String) -> UnboxedType?)) throws -> UnboxedFields {
